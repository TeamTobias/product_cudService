...
public class ProductController{
        ...
        public HttpStatus addProduct(@RequestBody RequestProduct requestProduct){
            // 상품 등록
        ...
        public HttpStatus deleteProduct(@PathVariable("itemId") int itemId){
            productService.deleteProduct(itemId);
            return HttpStatus.OK;
        }

        @PostMapping("/product/v1/{itemId}/{saleRate}")
        public HttpStatus setProductSale(@PathVariable("itemId") int itemId,@PathVariable("saleRate") int saleRate){
        ...
        public HttpStatus setProductCount(@PathVariable("productId") int productId,@PathVariable("amount") int amount){
